...
new const snd_fire[][] = { "jbe_core/plasma/plasma_fire.wav" }
new const snd_reload[][] = { "jbe_core/plasma/plasma_reload.wav" }
new const snd_hit[][] = { "jbe_core/plasma/plasma_hit.wav" }
...
public plugin_init() 
{
	register_plugin("[Jbe] Plasma Rifle", VERSION, AUTHOR)
...
public plugin_natives() register_native("weapon_azimov", "GetPlasma", 1)

public plugin_precache()
{
	precache_model("models/jbe_core/plasma/v_plasma.mdl")
	precache_model("models/jbe_core/plasma/p_plasma.mdl")
...
public event_CurWeapon(id)
{
	...
	entity_set_string(id, EV_SZ_viewmodel, "models/jbe_core/plasma/v_plasma.mdl")
	entity_set_string(id, EV_SZ_weaponmodel, "models/jbe_core/plasma/p_plasma.mdl")
	return PLUGIN_CONTINUE
}
